  ...
  slides = [
    {
      ...
      titleLine1: 'Gifting That',
      titleLine2: 'Speaks Gratitude',
      subtitle: 'Celebrate people. Strengthen relationships. Leave a lasting impression with premium, curated gifts.',
      cta: { label: 'Explore Gifting', link: '/services' },
      showcaseImg: 'assets/services/2.jpg',
      badge1: { icon: 'groups', value: '50+', label: 'Brands Served' },
      badge2: '100% Quality Assured',
    },
    {
      id: 2,
      ...
      titleLine2: 'Occasion',
      subtitle: 'From onboarding kits to festive hampers — we make every corporate moment truly unforgettable.',
      cta: { label: 'View Catalog', link: '/services' },
      showcaseImg: 'assets/gallery/3.jpg',
      badge1: { icon: 'card_giftcard', value: '500+', label: 'Gifts Delivered' },
      badge2: 'Pan-India Delivery',
    },
    {
      id: 3,
      imgSrc: 'assets/Slider/3.jpg',
      eyebrow: 'Custom Printing & Packaging',
      titleLine1: 'Smart. Stylish.',
      titleLine2: 'Memorable.',
      subtitle: 'Corporate gifts and packaging crafted to impress, inspire, and convert — every single time.',
      cta: { label: 'Start a Project', link: '/contact' },
      showcaseImg: 'assets/services/3.jpg',
      badge1: { icon: 'local_shipping', value: '5+', label: 'Cities Covered' },
      badge2: 'Custom Branding',
    },
  ];
